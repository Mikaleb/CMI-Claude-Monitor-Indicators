...
class LastUsedParams:
    ...
    def __init__(self, config_dir: Optional[Path] = None) -> None:
        ...
        self.config_dir = config_dir or Path.home() / ".cmi"
...
class Settings(BaseSettings):
    """cmi - Real-time token usage monitoring for Claude AI"""
    ...
    def _get_system_timezone() -> str:
        ...
        from cmi.utils.time_utils import get_system_timezone
    ...
    def _get_system_time_format() -> str:
        """Lazy import to avoid circular dependencies."""
        from cmi.utils.time_utils import get_system_time_format
    ...
    def load_with_last_used(cls, argv: Optional[List[str]] = None) -> "Settings":
        ...
        if settings.theme == "auto" or (
            ...
            from cmi.terminal.themes import (
                BackgroundDetector,
                BackgroundType,
            )
