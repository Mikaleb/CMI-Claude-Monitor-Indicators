...
from cmi.ui.display_controller import (
    DisplayController,
    LiveDisplayManager,
    ScreenBufferManager,
    SessionCalculator,
...
class TestDisplayController:
    ...
    def controller(self) -> Any:
        with patch("cmi.ui.display_controller.NotificationManager"):
    ...
    @patch("cmi.ui.display_controller.calculate_hourly_burn_rate")
    ...
    @patch("cmi.ui.display_controller.Plans.is_valid_plan")
    ...
    @patch("cmi.ui.display_controller.TimezoneHandler")
    @patch("cmi.ui.display_controller.get_time_format_preference")
    @patch("cmi.ui.display_controller.format_display_time")
    ...
    @patch("cmi.ui.display_controller.normalize_model_name")
    ...
    @patch("cmi.ui.display_controller.Plans.is_valid_plan")
    @patch("cmi.core.plans.get_cost_limit")
    @patch("cmi.ui.display_controller.Plans.get_message_limit")
...
class TestLiveDisplayManager:
    ...
    @patch("cmi.ui.display_controller.Live")
...
class TestScreenBufferManager:
    ...
    @patch("cmi.terminal.themes.get_themed_console")
    @patch("cmi.ui.display_controller.Text")
    @patch("cmi.ui.display_controller.Group")
...
class TestDisplayControllerAdvanced:
    ...
    @patch("cmi.ui.display_controller.AdvancedCustomLimitDisplay")
    @patch("cmi.ui.display_controller.Plans.get_message_limit")
    @patch("cmi.core.plans.get_cost_limit")
...
class TestSessionCalculator:
    ...
    def test_calculate_cost_predictions_with_cost(self, calculator):
        ...
        with patch("cmi.ui.display_controller.datetime") as mock_datetime:
...
@patch("cmi.ui.display_controller.ScreenBufferManager")
def test_create_screen_renderable_legacy(mock_manager_class):
    ...
    from cmi.ui.display_controller import create_screen_renderable
