...
from cmi.core.calculations import (
    BurnRateCalculator,
    _calculate_total_tokens_in_hour,
    _process_block_for_burn_rate,
    calculate_hourly_burn_rate,
)
from cmi.core.models import BurnRate, TokenCounts, UsageProjection
...
class TestBurnRateCalculator:
    ...
    @patch("cmi.core.calculations.datetime")
...
class TestHourlyBurnRateCalculation:
    ...
    @patch("cmi.core.calculations._calculate_total_tokens_in_hour")
    ...
    @patch("cmi.core.calculations._process_block_for_burn_rate")
    ...
    @patch("cmi.core.calculations._parse_block_start_time")
    ...
    @patch("cmi.core.calculations._determine_session_end_time")
    @patch("cmi.core.calculations._parse_block_start_time")
...
class TestP90Calculator:
    ...
    def test_p90_config_creation(self) -> None:
        ...
        from cmi.core.p90_calculator import P90Config
    ...
    def test_did_hit_limit_true(self) -> None:
        ...
        from cmi.core.p90_calculator import _did_hit_limit
    ...
    def test_extract_sessions_basic(self) -> None:
        ...
        from cmi.core.p90_calculator import _extract_sessions
    ...
    def test_calculate_p90_from_blocks_with_hits(self) -> None:
        ...
        from cmi.core.p90_calculator import (
            P90Config,
    ...
    def test_p90_calculator_custom_config(self) -> None:
        ...
        from cmi.core.p90_calculator import P90Calculator, P90Config
