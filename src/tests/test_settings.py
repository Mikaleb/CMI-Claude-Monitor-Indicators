...
from cmi.core.settings import LastUsedParams, Settings
...
class TestLastUsedParams:
    ...
    @patch("cmi.core.settings.logger")
...
class TestSettings:
    ...
    @patch("cmi.core.settings.Settings._get_system_timezone")
    @patch("cmi.core.settings.Settings._get_system_time_format")
    ...
    def test_load_with_last_used_clear_flag(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("cmi.core.settings.LastUsedParams") as MockLastUsed:
                mock_instance = Mock()
    ...
    @patch("cmi.core.settings.Settings._get_system_timezone")
    @patch("cmi.core.settings.Settings._get_system_time_format")
    @patch("cmi.terminal.themes.BackgroundDetector")
    def test_load_with_last_used_theme_detection(
        ...
        from cmi.terminal.themes import BackgroundType
    ...
    def test_complete_workflow(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("cmi.core.settings.LastUsedParams") as MockLastUsed:
                ...
                with (
                    patch(
                        "cmi.core.settings.Settings._get_system_timezone",
                        return_value="UTC",
                    ),
                    patch(
                        "cmi.core.settings.Settings._get_system_time_format",
                        return_value="24h",
                    ),
                ):
