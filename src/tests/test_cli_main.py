...
class TestMain:
    ...
    def test_version_flag(self) -> None:
        ...
        with patch("builtins.print") as mock_print:
            ...
            assert "cmi" in mock_print.call_args[0][0]
    ...
    @patch("cmi.core.settings.Settings.load_with_last_used")
    ...
    def test_successful_main_execution(self, mock_load_settings: Mock) -> None:
        ...
        actual_module = sys.modules["cmi.cli.main"]
        ...
        try:
            with (
                patch("cmi.terminal.manager.setup_terminal"),
                patch("cmi.terminal.themes.get_themed_console"),
                patch("cmi.ui.display_controller.DisplayController"),
                patch(
                    "cmi.monitoring.orchestrator.MonitoringOrchestrator"
...
class TestFunctions:
    ...
    def test_get_standard_claude_paths(self) -> None:
        ...
        from cmi.cli.main import get_standard_claude_paths
    ...
    def test_discover_claude_data_paths_no_paths(self) -> None:
        ...
        from cmi.cli.main import discover_claude_data_paths
