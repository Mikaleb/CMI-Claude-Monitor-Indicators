...
class TestAnalyzeUsage:
    ...
    @patch("cmi.data.analysis.load_usage_entries")
    @patch("cmi.data.analysis.SessionAnalyzer")
    @patch("cmi.data.analysis.BurnRateCalculator")
...
class TestCreateResult:
    ...
    @patch("cmi.data.analysis._convert_blocks_to_dict_format")
...
class TestBlockConversion:
    ...
    @patch("cmi.data.analysis._create_base_block_dict")
    @patch("cmi.data.analysis._add_optional_block_data")
